...
<?php
    ...
    foreach ($response as $goal)
        echo '<a class="" href="/goal/' . $goal['goalID'] . '"><img style="width: 200px; height: 200px;" alt="'.$goal['goalName'].'" class="feature bg-primary bg-gradient text-white transparentLink" src="' . $goal['goalPicture'] . '"></a>';
php?>
                    </div>
                </div>
            </div>

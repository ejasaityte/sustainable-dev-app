...
<?php
    ...
    if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
        ...
        if ($_SESSION['username']=='admin') echo '<li class="nav-item"><a class="nav-link" id="addtour" href="/addtour">Add Tour</a></li><li class="nav-item"><a class="nav-link" id="adduser" href="/adduser">Add User</a></li>';
        echo '<li class="nav-item"><a class="nav-link" id="addevent" href="/addevent">Add Event</a></li><li class="nav-item"><a class="nav-link" id="favouriteslist" href="/favouriteslist">Favourites</a></li><li class="nav-item"><a class="nav-link" id="changepassword" href="/changepassword">Change password</a></li><li class="nav-item"><a class="nav-link" id="logout" href="/logout">Log out</a></li>';
